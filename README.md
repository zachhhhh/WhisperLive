...
Use WhisperLive on iOS with our native iOS client supporting real-time STT and translation.
Refer to [`Audio-Transcription-iOS`](https://github.com/zachhhhh/WhisperLive/tree/main/Audio-Transcription-iOS) and [`README.md`](https://github.com/zachhhhh/WhisperLive/blob/main/Audio-Transcription-iOS/README.md) for setup and usage instructions.

## Android Client

Use WhisperLive on Android with our native Android client supporting real-time STT and translation.
Refer to [`Audio-Transcription-Android`](https://github.com/zachhhhh/WhisperLive/tree/main/Audio-Transcription-Android) for setup in Android Studio and usage instructions in [`README.md`](https://github.com/zachhhhh/WhisperLive/blob/main/Audio-Transcription-Android/README.md).

## Desktop Client (Windows & macOS)

Use the cross-platform Electron-based desktop client for Windows and macOS, supporting real-time STT and translation.
Refer to [`Desktop-Client-Windows`](https://github.com/zachhhhh/WhisperLive/tree/main/Desktop-Client-Windows) (works on both platforms).

Setup:

- Install Node.js (v18+)
- `cd Desktop-Client-Windows`
- `npm install`
- `npm start` to run
